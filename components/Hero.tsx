    ...
    <section className="max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row ">
      ...
      <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
        <Image
          ...
          width={50}
          height={50}
          className="absolute left-[5px] top-[-33px] w-10 lg:w-[50px] max-lg:left-[-3px]"
        />
        <h1 className="bold-52 lg:bold-88">Gunhad's Camp Area</h1>
        <p className="regular-16 mt-14 text-gray-30 max-w-[520px]">
      ...
      <div className="relative flex flex-1 items-start">
        <div className="relative z-20 w-[268px] flex flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8">
          <div className="flex flex-col">
            ...
            <p className="text-[20px] font-[700] text-white">Gurgaon</p>
          </div>
          <div className="flexBetween">
            <div className="flex flex-col">
              <p className="regular-16 text-gray-20">Distance</p>
              <p className="bold-20 text-white">10 km</p>
            </div>
            <div className="flex flex-col">
